        ...
        <div className="service">
            ...
            <div className="service-contaier">
                <div className="service-row-1">
                    <p className="icon-a" href=""><img className="icon" src={tugas} alt=""/> Tugas</p>
                    <p className="icon-a"><img className="icon" src={website} alt="" />Website</p>
                   <p className="icon-a"> <img className="icon" src={skripsi} alt="" />Skripsi</p>
                </div>
